...
kubectl apply -n persist -f "$ANOUNCY_PROJECT_PATH/ops/helm/mongo/mongo-password-secret.yaml"
helm repo add bitnami https://charts.bitnami.com/bitnami
helm install prod-mongodb  -n persist bitnami/mongodb --version 13.6.2 --values "$ANOUNCY_PROJECT_PATH/ops/helm/mongo/values.yaml"
